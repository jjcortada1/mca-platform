...
/**
 * VAPID key → the ArrayBuffer the Push API wants. Returns the buffer rather
 * than the view: lib.dom types applicationServerKey as an ArrayBuffer-backed
 * view, and a plain Uint8Array is only ArrayBufferLike.
 */
